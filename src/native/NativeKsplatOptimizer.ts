  ...
  if (nativeOptimizerModule.getAvailability) {
    try {
      ...
      return {
        ...
        moduleName: "ForgeScanKsplatOptimizer",
        optimizerName: "fixed-camera-turntable-3dgs-android-v1",
        qualityTier: "turntable-production-v1",
        ksplatEngineStatus: "turntable-3dgs-running",
        ksplatWriterStatus: "experimental-ksplat",
        optimizerRuntimeStatus: "trainable-loop-available",
        optimizerBlocker: "none",
        production3dgs: true,
        production3dgsStatus: "turntable-3dgs-running",
